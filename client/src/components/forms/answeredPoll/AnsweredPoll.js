...
import { Container, Card, Col, Row, Image, ProgressBar, Button } from "react-bootstrap";
import { Link } from "react-router-dom";

const AnsweredPoll = ({ id }) => {

    const { authReducer, users, questions } = useSelector(state => state);
                    ...
                    <Row className='px-0 gx-0 no-gutters'>
                        ...
                        <Col lg={10} md={8} className=''>
                            ...
                            <Card.Body className=''>
                                ...
                                {optionOne.votes.includes(authReducer) && <p style={{ float: 'right' }}>Your vote</p>}
                                ...
                                {optionTwo.votes.includes(authReducer) && <p style={{ float: 'right' }}>Your vote</p>}
                                <hr></hr>
                                <Link to='/'>
